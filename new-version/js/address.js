...
/*        if (max_kd < 91) {
        ...
        $(qyp).text(csgs2[0]);
        $(this).parentsUntil('.m_zlxg').parent().parent().find('.sfdq_num').val(sfnum);


        /*------------------*/
        $(csli).click(function() {
            var dqcs = $(this).text();
            var dqsf_num = $(this).parentsUntil('.m_zlxg').parent().parent().find('.sfdq_num').val();
            if (dqsf_num == "") {
                dqsf_num = 0;
            } else {
                var dqsf_num = $(this).parentsUntil('.m_zlxg').parent().parent().find('.sfdq_num').val();
            ...
            $(qyp).text(qygs[0]);
            $(this).parentsUntil('.m_zlxg').parent().parent().find('.csdq_num').val(csnum);
    ...
    /*---------------------------------------------------------------------*/
    $(shenfen).parent().find('.m_zlxg').click(function() {
    	//alert($(sfp).text());
        $(this).parent().parent().find('.sfdq_tj').val($(sfp).text());
        $(this).parent().parent().find('.csdq_tj').val($(csp).text());
        $(this).parent().parent().find('.qydq_tj').val($(qyp).text());
    }) //表单传值获取

};

$(function(){
	$('.sjld').each(function(index){
		//alert(index);
		$(this).css('zIndex',$('.sjld').length*1000-index);
	});
});
